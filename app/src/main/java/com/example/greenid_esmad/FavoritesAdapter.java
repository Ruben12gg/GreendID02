...
public class FavoritesAdapter extends RecyclerView.Adapter<FavoritesAdapter.ViewHolder> {
    ...
    public void onBindViewHolder(final ViewHolder holder, final int position) {
        ...
        String authorId = contentFavorites.getAuthorId();
        String location = contentFavorites.getLocation();
        String likesVal = contentFavorites.getDate();
        String commentVal = contentFavorites.getCommentVal();
        String date = contentFavorites.getLikeVal();
        String description = contentFavorites.getDescription();
        String postId = contentFavorites.getPostId();
        String userId = contentFavorites.getUserId();
        String ecoIdea = contentFavorites.getEcoIdea();
        String eventDate = contentFavorites.getEventDate();
        String eventTime = contentFavorites.getEventTime();
        String impactful = contentFavorites.getImpactful();
        String postType = contentFavorites.getPostType();
