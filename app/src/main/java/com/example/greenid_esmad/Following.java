...
public class Following extends AppCompatActivity {
    ...
    ArrayList<ContentFollowing> contentFollowing = new ArrayList<>();
                    ...
                    public void onComplete(@NonNull Task<QuerySnapshot> task) {
                        if (task.isSuccessful()) {
                            for (QueryDocumentSnapshot document : task.getResult()) {
                                ...
                                contentFollowing.add(new ContentFollowing(profileName, pfp, id));
    ...
    private void RecyclerCall() {
        ...
        followingAdapter = new FollowingAdapter(this, contentFollowing);
